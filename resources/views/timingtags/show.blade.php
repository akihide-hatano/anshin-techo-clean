        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('timing-tags.store') }}">
                        @csrf
                        ...
                        {{-- 表示順序 --}}
                        <div class="mb-6">
                            <label for="sort_order" class="block text-sm font-medium text-gray-700">表示順序 (数字)</label>
